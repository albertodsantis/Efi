...
export default function ServicesBlock({
  ...
  const hidden = getHiddenComponents('services', enabledComponents);

  return (
    <div className="grid gap-6">
      {isComponentEnabled('services_header', enabledComponents) && (
        <ComponentSection label="Descripción del servicio" onRemove={() => onRemoveComponent?.('services_header')}>
      ...
      {isComponentEnabled('offerings', enabledComponents) && (
        <ComponentSection label="Paquetes y tarifas" onRemove={() => onRemoveComponent?.('offerings')}>
          <div className="grid gap-4">
